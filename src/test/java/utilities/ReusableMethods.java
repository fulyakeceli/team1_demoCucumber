...
public class ReusableMethods {
    ...
    public static void clickAndVerifyLink(WebElement link, WebElement instagramLink, String expectedUrl) throws InterruptedException {
        // Orijinal pencereyi kaydet
        ...
        ((org.openqa.selenium.JavascriptExecutor) Driver.getDriver())
                .executeScript("window.open(arguments[0])", link.getAttribute("href"));

        Thread.sleep(2000); // Sayfanın açılması için bekle
